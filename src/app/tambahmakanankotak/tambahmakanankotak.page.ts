...
@Component({
  selector: 'app-tambahmakanankotak',
  templateUrl: './tambahmakanankotak.page.html',
  styleUrls: ['./tambahmakanankotak.page.scss'],
})
export class TambahmakanankotakPage implements OnInit {
 constructor(
  ...
  getPostData(idPaket,namaMakanan){
      ...
      this.presentLoading(true);
  		this.http.post('http://'+this.loginservice.host+'/kevyn/tambahmakanankotak.php',{'id':idPaket,'makanan':namaMakanan},{})
  		.then(data => {
  			if(data.data == 'gagal'){
